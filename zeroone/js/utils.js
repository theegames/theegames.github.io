...
function Utility() {
  ...
  setColorScheme: function(c1) {
    ...
    var css = '' +
      '.odd  .tile-1 .inner { background-color: #FF0082; }' +
      '.even .tile-1 .inner { background-color: #FF0082; }' +
      '.odd  .tile-2 .inner { background-color: #0037FF; }' +
      '.even .tile-2 .inner { background-color: #0037FF; }';
    Utils.createCSS(css);
  }
